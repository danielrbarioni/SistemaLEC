...
sftp = ssh.open_sftp()
# Copiar o banco local exato para a VM
...
print('Perfis restaurados no banco da VM:', cursor.fetchall())

cursor.execute(\\\"SELECT COUNT(*) FROM solicitacoes WHERE data_criacao LIKE '%2026-07-24%'\\\")
print('Solicitações restantes do dia 24/07/2026:', cursor.fetchone()[0])
conn.close()
" """)

print("Resultado do upload e limpeza:\n", stdout.read().decode('utf-8', errors='replace'))
ssh.close()
